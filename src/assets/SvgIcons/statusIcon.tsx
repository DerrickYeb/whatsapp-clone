...
export const StatusIcon = ({version,id,x,y,viewBox,width,height,fill,}:SVGProps<SVGSVGElement>) => (
    <svg version="1.1" id="df9d3429-f0ef-48b5-b5eb-f9d27b2deba6" cursor='pointer' aria-label="Status" x="0" y="0" viewBox="0 0 24 24" width="24" height="24" className="" >
